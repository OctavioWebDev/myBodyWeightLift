            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                    <div className="flex justify-center">
                        <div className="relative w-80 h-[480px] rounded-xl overflow-hidden shadow-2xl border-4 border-yellow-500/30">
                            <Image
                                src="/assets/images/shut-up-and-lift-book-cover.png"
                                alt="Shut Up and Lift Book Cover"
                                fill
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <a
                                href="https://www.amazon.com/dp/B0GF41CCDH"
                                target="_blank"
